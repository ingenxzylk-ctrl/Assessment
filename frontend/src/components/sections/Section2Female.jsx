        ...
        {subStep === 5 && (
          <div className="animate-[fadeIn_0.2s_ease-out]">
            <div className="mb-6">
              ...
              <p className="text-gray-400 mt-1 text-xs">
                This helps us distinguish a sudden increase in shedding from gradual pattern thinning.
              </p>
            </div>

            <div className="grid grid-cols-1 gap-3">
              {[
                { id: "under_6m", label: "Suddenly,within a few weeks" },
                { id: "6m_1y", label: "Gradually,over several months or years" },
                { id: "1y_3y", label: "it comes and goes" },
                { id: "over_3y", label: "I noticed shedding after illness,childbirth,stress,or weight change" }
