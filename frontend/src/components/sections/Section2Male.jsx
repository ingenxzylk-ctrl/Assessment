...
const HAIR_STAGES = [
  { id: "1", title: "Stage 1", desc: "Full hairline, no visible recession.", img: "/stages/Stage1.png" },
  { id: "2", title: "Stage 2", desc: "Minor recession at the temples.", img: "/stages/Stage2.png" },
  { id: "3", title: "Stage 3", desc: "Clearer M-shape temple recession.", img: "/stages/Stage3.png" },
  { id: "4", title: "Stage 4", desc: "Temple recession with crown thinning.", img: "/stages/Stage4.png" },
  { id: "5", title: "Stage 5", desc: "Larger front and crown bald areas.", img: "/stages/Stage5.png" },
  { id: "6", title: "Stage 6", desc: "Bridge largely gone; horseshoe forming.", img: "/stages/Stage6.png" },
  { id: "7", title: "Stage 7", desc: "Narrow band of hair on sides and back.", img: "/stages/Stage7.png" },
  {
    id: "overall-thinning",
...
export default function Section2Male({ onComplete, onBack }) {
  ...
  const [subStep, setSubStep] = useSectionStep("section2Male", HAIR_TOTAL - 1, 0);
  ...
  const isCurrentAnswered = () => {
    if (subStep === 0) return Boolean(localForm.norwood_stage);
    if (subStep === 1) return Boolean(localForm.hair_fall_zone);
  ...
  const handleContinue = () => {
    ...
    // Persist as user advances so answers cannot be lost / skipped on resume
    if (updateHairHealth) updateHairHealth(localForm);
                  ...
                  >
                    <div className="mb-3 w-full flex justify-between items-start gap-1">
                      <div className="min-w-0">
                        ...
                        <p className="text-[10px] text-gray-400 font-medium leading-tight mt-0.5 truncate max-w-[200px]">
                          {stage.desc}
                        </p>
                      </div>
                      <div
        ...
        {subStep === 1 && (
          <div className="animate-[fadeIn_0.2s_ease-out]">
            ...
            <div className="grid grid-cols-1 gap-3 mt-4">
              {LOCATION_ROWS.map((opt) => radioRow(opt, "hair_fall_zone"))}
            </div>
          </div>
        )}
