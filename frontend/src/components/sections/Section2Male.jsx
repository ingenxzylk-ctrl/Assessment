        ...
        {subStep === 1 && (
          <div className="animate-[fadeIn_0.2s_ease-out]">
            <div className="mb-4">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-3 leading-tight">Where have you noticed hair loss or thinning?</h2>
              <p className="text-gray-400 mt-1 text-xs">This helps us understand which areas are most affected.</p>
            </div>
        ...
        {subStep === 2 && (
          <div className="animate-[fadeIn_0.2s_ease-out]">
            <div className="mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mt-3 leading-tight">Are you shedding more hair than usual?</h2>
              <p className="text-gray-400 mt-1 text-xs">Think about what you notice in the shower,on your brush,pillow or clothing.</p>
            </div>

            <div className="grid grid-cols-1 gap-3">
              {[
                { id: "under_50", label: "About the same as usual" },
                { id: "50_100", label: "Slightly more than usual" },
                { id: "100_150", label: "Much more than usual" },
                { id: "over_150", label: "Hair is coming out in noticeable clumps" }
              ].map((opt) => (
                <button
                  key={opt.id}
                  type="button"
