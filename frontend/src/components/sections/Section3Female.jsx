...
const STEP_TITLES = {
  iron_level: {
    title: "What is your iron level status?",
    subtitle: "Iron levels heavily affect hair growth cycles.",
  },
  symptoms: {
  ...
  energy_level: {
    title: "How is your daytime energy level?",
    subtitle: "Energy metrics help identify metabolic balance.",
  },
  supplements: {
            ...
            <div className="grid grid-cols-1 gap-3">
              {(currentStep === "life_stage"
                ...
                : currentStep === "digestion"
                  ? ["Perfect / No Issues", "Frequent Bloating / Gas", "Chronic Constipation"]
                  : currentStep === "sleep_cycle"
                    ? ["Less than 5 hours", "6 to 8 hours", "9+ hours"]
                    : currentStep === "stress_level"
                      ? ["Low / Manageable", "Moderate / Daily Tension", "High / Severe Stress"]
                      : currentStep === "energy_level"
                        ? ["Normal", "Low in afternoon ", "Very Low"]
