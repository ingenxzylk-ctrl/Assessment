        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          {cartItems.length === 0 ? (
            ...
            cartItems.map((item) => (
              <div
                key={item.id}
                className="p-3 rounded-2xl border border-gray-100 bg-gray-50/50 space-y-3"
              >
                <div className="flex gap-4 justify-between items-center">
                  ...
                  <div className="flex items-center gap-2.5 bg-white border border-gray-200 px-2 py-1 rounded-xl">
                    <button
                      ...
                      className="text-gray-500 font-bold px-1 text-sm cursor-pointer"
                    >
                      -
                    </button>
                  ...
                  <button
                    ...
                    className="text-red-400 hover:text-red-600 text-sm font-bold pl-2 cursor-pointer"
                  >
                    🗑️
                  </button>
                </div>
        ...
        {cartItems.length > 0 && (
          <div className="p-6 border-t border-gray-100 bg-gray-50 space-y-4">
            ...
            <button
              type="button"
              onClick={() => setIsCartOpen(false)}
              className="w-full min-h-[3.25rem] bg-[#064e3b] text-white rounded-xl font-semibold hover:bg-[#043427] transition-all tracking-wide text-sm shadow-sm cursor-pointer"
            >
              Continue
            </button>
          </div>
