...
export const HAIR_FALL_LOCATION = [
  ...
  { id: "parting", label: "Parting line / mid-scalp", img: "/stagesf/stage2.png" },
...
// Genetic Lineage Options
export const FAMILY_HISTORY = [
  { id: "father", label: "Yes, on my father's side" },
  { id: "mother", label: "Yes, on my mother's side" },
  { id: "both", label: "Yes, on both parental sides" },
  { id: "none", label: "No known family history of hair loss" },
];
