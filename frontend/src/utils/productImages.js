 ...
 *   frontend/src/assets/products/   ← recommended (Vite bundles, always works)
 *   frontend/public/products/       ← served at /products/filename.jpg
 *
 * Expected filenames:
 *   antidandruff-shampoo.jpg, dermaroller.jpg, detox-shampoo.jpg, health-mix.jpg,
 *   minoxidil-2.jpg, minoxidil-5.jpg, progro-oil.jpg, rosemary-mist.jpg,
 *   rosemary-oil.jpg, scalp-massager.jpg, tea-tree-conditioner.jpg
 */

const EXTENSIONS = ["jpg", "jpeg", "png", "webp", "svg"];

/** Vite bundles any images you drop in src/assets/products/ */
...
/** Returns primary URL + ordered fallbacks for <img> onError */
